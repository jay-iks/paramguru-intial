...
const UploadStoryForm = ({ setshowupload }) => {
  return (
    <div>
      <form className="w-[100%]  p-[20px] mt-4">
        ...
        >
          ...
          <div>Upload Video / Recordings or Audio Here</div>
          <input
            type="file"
            name="media_image"
            placeholder="Browse"
        ...
        <div className="flex justify-evenly mt-[5px]">
          ...
          <div
            className="text-1 text-[#ffffff] rounded-[100px] bg-[#aa7b2c] hover:bg-[#ffffff] hover:text-[#aa7b2c] border-2 border-[#aa7b2c] px-[15px] py-[5px]   "
